...
- O prestador deve receber uma notificação sempre que houver um nov agendamento;
...
- Os agendamentos devem estar disponíveis  entre 8h às 18hs (primeiro às 8h, último às 17h);
